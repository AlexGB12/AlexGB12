...
<p align = "center">
	<img src = "https://github.com/AlexGB12/AlexGB12/blob/output/github-contribution-grid-snake.svg?" alt = "Snake Game"/>
</p>
...
  </div>
  <div align=center>
      <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com/?font=VT323&size=35&duration=3500&pause=300&color=6A0572&center=true&vCenter=true&width=500&lines=Hey%2C+I+am+Alex;Welcome+to+My+GitHub+Profile;Inquisitive+and+Curious+by+nature;Software+and+Computer+Engineer;Backend+and+iOS+Developer;CS2+and+Football+Lover;Hardworking+and+Ambitious;Gym+Freak;Music+and+Programming+Lover" alt="Typing SVG" /></a>
  </div>
</div>
...
 *
 * @constructor
 * @param {string} location - Tu ubicación aquí.
 * @param {string} languagues - Tus idiomas aquí.
 * @param {string} jobTitle - Tu profesión o rol.
 * @param {string} specialization - Tu especialización.
 * @param {string} interests - Tus intereses.
 * @param {string} hobbies - Tus hobbies.
 * @param {string} education - Tu educación.
 * @param {string} approachable - Sí, para colaborar en proyectos interesantes.
 * @param {string} stength - Tus puntos fuertes.
 * @param {string} weakness - Tus debilidades.
 *
 * @throws {Punch} A todos y cada uno de los bugs.
 *
 * @returns {Object} Alex.
 */
</div>
...
    <br>
    <kbd>
      <kbd>Automatización, Ciencia de Datos & AI</kbd>
      <br>
      <br>
...
    </kbd>
    <kbd>
      <kbd>Sistema Operativo, Redes & Despliegue</kbd>
      <br>
      <br>
...
  <br>
  <p align="center">
    <img align="center" src="https://www.google.com/search?q=https://github-readme-stats.vercel.app/api%3Fusername%3DAlexGB12%26show_icons%3Dtrue%26amp%3Bshow%3Dreviews,discussions_started,discussions_answered,prs_merged,prs_merged_percentage" alt="GitHub Stats">
  </p>
</details>
...
  <br>
  <ul>
    <li><strong>MDN Docs - Official JavaScript Docs:</strong> Contribuye a mejorar y mantener la documentación oficial de JavaScript en MDN Web Docs.</li>
    <li><strong>Pinterest - Pymemcache:</strong> Haz contribuciones al proyecto Pymemcache en Pinterest, un cliente Python eficiente para el sistema de cacheo memcached.</li>
    <li><strong>The Algorithms - JavaScript and C++:</strong> Contribuye al repositorio The Algorithms, particularmente en implementaciones de varios algoritmos y estructuras de datos en JavaScript y C++.</li>
   <li><strong>True Sparrow - NftorNot.com, WhisperChain.xyz, AI SalesSparrow:</strong> Lidera el desarrollo de proyectos desde la concepción hasta la producción bajo True Sparrow.</li>
  </ul>
</details>
...
Si tienes preguntas sobre desarrollo web, documentación o AI, no dudes en <a href="mailto:kkapgate5@gmail.com">contactarme por email</a>.
